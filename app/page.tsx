...
import { ArrowRight, GraduationCap, Clock, Calendar, Award } from "lucide-react"
    ...
    <div className="min-h-screen bg-gradient-to-b from-teal-50 to-white">
      ...
      <header className="container mx-auto py-6 px-4 flex justify-between items-center">
        ...
        <nav>
          <ul className="flex gap-6">
            <li>
              <a href="#sobre" className="text-gray-700 hover:text-teal-600 transition-colors">
                Sobre
              </a>
            </li>
            <li>
            ...
            <li>
              <a href="#contato" className="text-gray-700 hover:text-teal-600 transition-colors">
                Contato
              </a>
            </li>
          </ul>
      ...
      <section className="container mx-auto px-4 py-20 flex flex-col md:flex-row items-center gap-12">
        <div className="flex-1 space-y-6">
          ...
          <div className="pt-4">
            <Link href="/curso">
              <Button className="bg-teal-600 hover:bg-teal-700 text-white px-8 py-6 rounded-lg text-lg font-medium transition-all hover:shadow-lg flex items-center gap-2 group">
                Iniciar
        ...
        <div className="flex-1 relative">
          <div className="relative w-full h-[400px]">
            <Image
              ...
              alt="Estudantes planejando seu fluxo acadêmico"
              fill
              className="object-contain rounded-lg shadow-lg animate-float"
            />
          </div>
        </div>
      </section>
      ...
      <section id="como-funciona" className="bg-white py-20">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            <div className="bg-teal-50 p-8 rounded-xl shadow-sm hover:shadow-md transition-shadow">
            ...
            <div className="bg-emerald-50 p-8 rounded-xl shadow-sm hover:shadow-md transition-shadow">
              <div className="w-14 h-14 bg-emerald-600 rounded-full flex items-center justify-center mb-6">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto">
            <div className="relative">
              {/* Timeline */}
              <div className="absolute left-0 md:left-1/2 h-full w-0.5 bg-teal-200 transform md:-translate-x-1/2"></div>
              ...
              <div className="relative flex flex-col md:flex-row items-center mb-16">
                ...
                <div className="z-10 flex items-center justify-center w-12 h-12 bg-teal-600 rounded-full text-white font-bold shadow-lg">
                  1
                </div>
          ...
          <div className="text-center mt-16">
            <Link href="/curso">
              <Button className="bg-teal-600 hover:bg-teal-700 text-white px-8 py-6 rounded-lg text-lg font-medium transition-all hover:shadow-lg flex items-center gap-2 mx-auto group">
                Começar agora
                <ArrowRight className="h-5 w-5 group-hover:translate-x-1 transition-transform" />
              </Button>
            </Link>
            ...
            <div className="flex gap-8">
              <div>
                ...
                <ul className="space-y-2">
                  ...
                  <li>
                    <a href="#sobre" className="text-gray-400 hover:text-teal-400 transition-colors">
                      Sobre
                    </a>
                  </li>
                  <li>
                    <a href="#como-funciona" className="text-gray-400 hover:text-teal-400 transition-colors">
                      Como Funciona
                    </a>
                  </li>
                </ul>
